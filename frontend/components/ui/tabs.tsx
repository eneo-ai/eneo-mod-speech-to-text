...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      // The same scale as Button: a mouse's density, 44 px tabs on a touch screen.
      "inline-flex h-9 items-center justify-center rounded-lg bg-muted p-1 text-muted-foreground coarse:h-auto",
      className
    )}
    {...props}
  />
