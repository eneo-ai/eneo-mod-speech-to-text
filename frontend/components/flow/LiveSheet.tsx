  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="min-h-0 flex-1 overflow-y-auto px-5 pb-8 pt-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring md:px-7"
      >
