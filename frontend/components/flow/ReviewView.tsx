...
import { RESULT_HEADINGS } from "@/components/flow/ResultDocument";
        ...
        <section className="paper-card p-4 mb-5">
          ...
          {editable && editing ? (
            ...
            <article className="prose prose-sm md:prose-base max-w-none text-[14px] md:text-[15px] leading-relaxed">
              ...
              <ReactMarkdown remarkPlugins={[remarkGfm]} components={RESULT_HEADINGS}>{decided ? initialText : text}</ReactMarkdown>
            </article>
          )}
